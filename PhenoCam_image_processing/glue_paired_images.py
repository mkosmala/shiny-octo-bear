...
if len(sys.argv) < 3 :
    print ("format: glue_paried_images <images_file> <output_dir> <output_list_file>")
    exit(1)
...
with open(imagefilename,'r') as imagefile, open(outputfilename,'w') as ofile:
    ...
    for line in imagefile:
        ...
        canvas1.save(outputdir + siteyear + newname1)
        canvas2.save(outputdir + siteyear + newname2)
